#' Chicago 311 Dead Animal Pick-Up Requests (2019–2021)
#'
...
#'
#' @format A data frame with one row per request, including the following columns:
#' \describe{
...
#'
#' @source \url{https://data.cityofchicago.org/Service-Requests/311-Service-Requests/v6vf-nfxy/about_data}
#'
"chicago_311"
